    ...
    void apply(Project project) {
        ...
        Task macReleaseApp = project.task("macReleaseApp").configure { Task task ->
            ...
            task.doFirst {
                ...
                def bootstrapScript = Methods.copyIntoDir(srcResources.resolve("baleout-bootstrap"), appMacOs)
        ...
        def deployOsBundles = project.task('deployOsBundles').configure { Task task ->
            ...
            task.doLast {
                ...
                GitHub gitHub = GitHubBuilder
                        .fromCredentials()
                        .build()
                def repository = gitHub.getRepository("TechShroom/UnplannedDescent")
