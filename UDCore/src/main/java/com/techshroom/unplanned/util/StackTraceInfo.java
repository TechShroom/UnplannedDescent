...
public class StackTraceInfo {
	...
	public static String getCurrentMethodNameFqn(int offset) {
		String currentClassName = getCurrentClassName(offset
				+ INVOKING_METHOD_ZERO);
		String currentMethodName = getCurrentMethodName(offset
				+ INVOKING_METHOD_ZERO);
	...
	public static String getCurrentFileNameFqn() {
		String CurrentMethodNameFqn = StackTraceInfo
				.getCurrentMethodNameFqn(INVOKING_METHOD_ZERO);
		String currentFileName = StackTraceInfo
				.getCurrentFileName(INVOKING_METHOD_ZERO);
	...
	public static String getInvokingMethodNameFqn(int offset) {
		String invokingClassName = getInvokingClassName(offset
				+ INVOKING_METHOD_ZERO);
		String invokingMethodName = getInvokingMethodName(offset
				+ INVOKING_METHOD_ZERO);
	...
	public static String getInvokingFileNameFqn() {
		...
		String invokingFileName = StackTraceInfo
				.getInvokingFileName(DUAL_INVOKING_METHOD_ZERO);
