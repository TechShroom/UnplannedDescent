...
public class Arrays2Test {
	...
	private static int[] SPL_original, SPL_normalcp, SPL_reversecp, SPL_bigstepcp, SPL_rbigstepcp;
	...
	public void createsArray() {
		assertArrayEquals(CREATE_equivarray, Arrays2.newArray(Object.class, CREATE_equivarray.length));
	}
